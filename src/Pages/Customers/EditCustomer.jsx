...
const EditCustomer = ({ props, customer, booking, editCustomer }) => {
  ...
  useEffect(() => {
    ...
    setCredito({
      label: customer?.credito === 'Aprobado' ? 'Aprobado' : 'No Aprobado',
      value: customer?.credito
    });
  }, [customer]);
  ...
  useEffect(() => {
    setDisableSave(
      !customerType ||
        ...
        !countryState ||
        !city ||
        (billingName.trim().length === 0 && !isSameAsCustomer)
    );
  }, [
    customerType,
    customerName,
                ...
                <div className="col-md-12 col-sm-12 mb-3 d-flex align-items-center">
                  <div className="flex-grow-1">
                    ...
                    <input
                      ...
                      value={billingName}
                      placeholder={
                        isSameAsCustomer ? 'ej. Juan Rafael Pérez Bolaños' : 'ej. Juan Pérez'
                      }
                  ...
                  <div className="form-check ms-3 mt-4">
                    <input
                      ...
                      onClick={() => {
                        handleOnClickIsSameAsCustomer();
                      }}
                    />
                    <label htmlFor="isSameAsCustomer" className="form-check-label ms-2">
                      Igual que Nombre
                    </label>
                  </div>
                </div>
