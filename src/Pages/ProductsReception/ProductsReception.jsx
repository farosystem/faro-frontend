...
import {
  convertDataProductReceptionExcel,
...
const ProductsReception = ({ ...props }) => {
  ...
  const {
    loading: load_recepcion_productos,
    error: error_recepcion_productos,
    data: data_recepcion_productos
  } = useQuery(OBTENER_RECEPCION_PRODUCTOS, { pollInterval: 1000 });
