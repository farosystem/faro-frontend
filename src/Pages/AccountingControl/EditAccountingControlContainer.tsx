...
const EditAccountingControlContainer = (props) => {
        ...
        <div className="page-content">
          <Container fluid={true}>
            <Breadcrumbs
              ...
              breadcrumbItem="Registro contable"
              breadcrumbItemUrl="/accountingcontrol"
            />
            <Row>
  ...
  return (
    <>
      <EditAccountingControl accountingControl={data.obtenerRegistroContable} tipo={tipo} />
    </>
  );
};
