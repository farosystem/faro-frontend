...
import {
  OBTENER_TIPOSHABITACION_BY_ID,
  UPDATE_TIPO_HABITACION
} from '../../../../services/TipoHabitacionService';
...
const EditTypeRoom = () => {
  ...
  const { id } = useParams();
  const {
    loading: loading_typeroom,
    error: error_typeroom,
    data: data_typeroom,
    startPolling,
    stopPolling
  } = useQuery(OBTENER_TIPOSHABITACION_BY_ID, { variables: { id: id }, pollInterval: 1000 });
        ...
        <div className="page-content">
          <Container fluid={true}>
            <Breadcrumbs
              ...
              breadcrumbItem="Tipo de habitación"
              breadcrumbItemUrl="/hotelsettings/typeroom"
            />
            <Row>
