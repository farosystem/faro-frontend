...
import {
  OBTENER_SERVICIO_EXTERNOS_BY_ID,
  UPDATE_SERVICIO_EXTERNO
...
const EditExtraService = ({ idBooking, updateServiceBooking }) => {
  ...
  const {
    ...
    startPolling,
    stopPolling
  } = useQuery(OBTENER_SERVICIO_EXTERNOS_BY_ID, {
        ...
        <div className="page-content">
          <Container fluid={true}>
            <Breadcrumbs
              ...
              breadcrumbItem="servicio externo"
              breadcrumbItemUrl="/hotelsettings/externalservice"
            />
            <Row>
          ...
          <Card className="p-4">
            ...
            <Row className="d-flex justify-content-between shadow_service rounded-5 p-3">
              <Col className="col-md-6  d-flex justify-content-center flex-wrap">
                ...
                <div className="col-md-11 col-sm-9 m-2">
                  <label htmlFor="type" className="form-label">
                    * Descripción del servicio externo
                  </label>
                  <input
                    className="form-control"
                    type="text"
