...
const EditLocation = () => {
  ...
  const {
    ...
    startPolling,
    stopPolling
  } = useQuery(OBTENER_UBICACION_BY_ID, { variables: { id: id }, pollInterval: 1000 });
  ...
  const onClickSave = async () => {
    try {
      ...
      showInfoAlert(
        'Oops',
        'Ocurrió un error inesperado al guardar la ubicación',
        'error',
        3000,
        'top-end'
      );
        ...
        <div className="page-content">
          <Container fluid={true}>
            <Breadcrumbs
              ...
              breadcrumbItem="Gestion de Ubicaciones"
              breadcrumbItemUrl="/locations"
            />
            <Row>
