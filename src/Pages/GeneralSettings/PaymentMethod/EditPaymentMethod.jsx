...
import {
  OBTENER_TIPOS_METODO_PAGO_BY_ID,
  UPDATE_TIPO_METODO_PAGO
} from '../../../services/TipoMetodoPagoService';
...
const EditPaymentMethod = () => {
  ...
  const { id } = useParams();
  const {
    loading: loading_paymentMethod,
    error: error_paymentMethod,
    data: data_paymentMethod,
    startPolling,
    stopPolling
  } = useQuery(OBTENER_TIPOS_METODO_PAGO_BY_ID, { variables: { id: id }, pollInterval: 1000 });
  ...
  const onClickSave = async () => {
    try {
      ...
      showInfoAlert(
        'Oops',
        'Ocurrió un error inesperado al guardar el metodo de pago',
        'error',
        3000,
        'top-end'
      );
        ...
        <div className="page-content">
          <Container fluid={true}>
            <Breadcrumbs
              ...
              breadcrumbItem="Gestion de Métodos de Pago"
              breadcrumbItemUrl="/paymentmethods"
            />
            <Row>
