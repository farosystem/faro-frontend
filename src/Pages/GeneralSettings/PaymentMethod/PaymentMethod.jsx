...
import {
  OBTENER_TIPOS_METODO_PAGO,
  DELETE_TIPO_METODO_PAGO
} from '../../../services/TipoMetodoPagoService';
import {
  convertirDataTipoMetodoPagoExcel,
...
const PaymentMethod = ({ ...props }) => {
  ...
  const {
    ...
    data: tipos,
    refetch
  } = useQuery(OBTENER_TIPOS_METODO_PAGO, { pollInterval: 1000 });
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumb
            title="Gestion de Métodos de Pago"
