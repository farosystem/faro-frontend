...
const EditMenuType = () => {
  ...
  const {
    ...
    startPolling,
    stopPolling
  } = useQuery(OBTENER_TIPOS_MENU_BY_ID, { variables: { id: id }, pollInterval: 1000 });
  ...
  const onClickSave = async () => {
    try {
      ...
      showInfoAlert(
        'Oops',
        'Ocurrió un error inesperado al guardar el tipo de menu',
        'error',
        3000,
        'top-end'
      );
      ...
      <React.Fragment>
        <div className="page-content">
          <Container fluid={true}>
            <Breadcrumbs
              title="Editar Tipo de Menu"
              breadcrumbItem="Gestion de Tipos de Menu"
              breadcrumbItemUrl="/menutype"
            />
            <Row>
