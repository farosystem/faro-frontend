...
const MenuType = ({ ...props }) => {
  ...
  const {
    ...
    data: tipos,
    refetch
  } = useQuery(OBTENER_TIPOS_MENU, { pollInterval: 1000 });
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumb
            title="Gestion de Tipos de Menu"
