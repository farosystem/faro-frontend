...
const EditCleanlinessCheck = ({ props, chequeo }) => {
  ...
  const onSave = async () => {
    try {
      ...
      showInfoAlert(
        'Oops',
        'Ocurrió un error inesperado al marcar como revisado el chequeo',
        'error',
        3000,
        'top-end'
      );
    ...
    <React.Fragment>
      <div className="page-content">
        <Container fluid={true}>
          <Breadcrumbs
            title="Revisar chequeo"
            breadcrumbItem="Chequeos"
            breadcrumbItemUrl="/cleaningjobs/checks"
          />
          <Row>
            <div className="col">
              {aprobado && <Alert className="w-100">Este chequeo ya fue revisado</Alert>}
              {!aprobado && (
              ...
              <Row>
                <div className="col mb-3">
                  ...
                  <input
                    ...
                    type="text"
                    id="fechaRegistro"
                    value={getFechaTZ('hora', fechaRegistro)}
                  />
                </div>
              </Row>
              {puestoLimpieza !== null && (
          ...
          {!aprobado && (
            <Row>
              <div className="col w-100">
                ...
                >
                  Marcar como revisado <i className="mdi mdi-check-bold align-middle ms-2"></i>
                </button>
              </div>
            </Row>
          )}
