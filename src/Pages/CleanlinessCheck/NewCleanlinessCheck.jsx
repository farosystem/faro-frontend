...
const NewCleanlinessCheck = (props) => {
  ...
  const { loading: load_puestos, data: data_puestos } = useQuery(OBTENER_PUESTO_LIMPIEZAS, {
    pollInterval: 1000
  });
  ...
  const onSave = async () => {
    try {
      ...
      showInfoAlert(
        'Oops',
        'Ocurrió un error inesperado al guardar el puesto de limpieza',
        'error',
        3000,
        'top-end'
      );
        ...
        <div className="page-content">
          <Container fluid={true}>
            <Breadcrumbs
              ...
              breadcrumbItem="Chequeos de limpieza"
              breadcrumbItemUrl="/cleaningjobs/checks"
            />
            <Row>
        ...
        <Container fluid={true}>
          ...
          <Row>
            <div className="col mb-3 text-end">
              ...
              >
                Registrar nuevo chequeo <i className="ri-save-line align-middle ms-2"></i>
              </button>
            </div>
          </Row>
          <Row>
                ...
                <div className="col mb-3">
                  ...
                  {!chequeoCargado ? (
                    ...
                    <input
                      ...
                      readOnly={true}
                      type="text"
                      value={puestoLimpieza.value.nombre}
                    />
                  )}
                </div>
              </Row>
                            ...
                            <tbody>
                              {areas.map((area, i) => (
                                <TrAreaCheck
                                  ...
                                  index={i}
                                  check={area.estado}
                                  onHandleCheckArea={onHandleCheckArea}
                                />
                              ))}
                            </tbody>
                          </table>
