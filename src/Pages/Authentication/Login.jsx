  ...
  const validation = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      const { data } = await autenticarUsuario({
        variables: { cedula: values.user, clave: values.password }
      });
              ...
              <Card>
                <CardBody className="p-4">
                  <div>
                    ...
                    <h4 className="font-size-18 text-muted mt-2 text-center">¡Bienvenido!</h4>
                    <p className="mb-5 text-center">Inicia sesión para continuar</p>
                    <Form
                          ...
                          <div className="mb-4">
                            ...
                            {validation.touched.user && validation.errors.user ? (
                              <FormFeedback type="invalid">
                                <div>{validation.errors.user}</div>
                              </FormFeedback>
                            ) : null}
                          </div>
                          <div className="mb-4">
