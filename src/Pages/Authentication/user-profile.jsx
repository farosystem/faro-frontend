...
const UserProfile = () => {
  ...
  const {
    ...
    error: error_user,
    data: data_user
  } = useQuery(OBTENER_USUARIO_CODIGO, { variables: { codigo: userId }, pollInterval: 1000 });
  ...
  const onClickSaveContactInfo = async () => {
    try {
      ...
      showInfoAlert(
        'Oops',
        'Ocurrió un error inesperado al actualizar la información de contacto',
        'error',
        3000,
        'top-end'
      );
                ...
                <div className="col-md-6 col-sm-12">
                  <Row>
                    ...
                    <div className="col mb-6 text-center align-self-center">
                      ...
                      >
                        Actualizar Contraseña <i className="ri-save-line align-middle ms-2"></i>
                      </button>
                    </div>
                  </Row>
                  <Row>
                    <div className="col-md-6 col-sm-12 mb-3">
                      ...
                      <div className="input-group">
                        <input
                          className={`form-control ${samePasswordError || passwordMatchError ? 'is-invalid' : ''}`}
                          type={showPassword ? 'text' : 'password'}
                          id="newPassword"
                          value={newPassword}
                          onChange={(e) => {
                    ...
                    <div className="col-md-6 col-sm-12 mb-3">
                      <label htmlFor="newPasswordR" className="form-label">
                        * Confrimar Nueva Contraseña
                      </label>
                      <div className="input-group">
                        <input
              ...
              <Row>
                <div className="col mb-3 text-center">
                  <button
                    ...
                    disabled={disableSaveContactInfo}
