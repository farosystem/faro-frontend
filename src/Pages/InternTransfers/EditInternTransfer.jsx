...
const EditInternTransfer = forwardRef(({ props, internTransfer }, ref) => {
  ...
  const { loading: load_lineas, data: data_lineas } = useQuery(
    OBTENER_LINEAS_TRANSFERENCIA_INTERNA,
    { variables: { id: internTransfer.id }, pollInterval: 1000 }
  );
