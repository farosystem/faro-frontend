...
const InternTransfers = ({ ...props }) => {
  ...
  const {
    loading: load_transferencias_internas,
    error: error_transferencias_internas,
    data: data_transferencias_internas
  } = useQuery(OBTENER_TRANSFERENCIAS, { pollInterval: 1000 });
