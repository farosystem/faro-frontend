...
const EditTaxManagement = (props) => {
  ...
  const {
    ...
    startPolling,
    stopPolling
  } = useQuery(OBTENER_IMPUESTO_BY_ID, { variables: { id: id }, pollInterval: 1000 });
  ...
  const onClickSave = async () => {
    try {
      ...
      showInfoAlert(
        'Oops',
        'Ocurrió un error inesperado al guardar el impuesto',
        'error',
        3000,
        'top-end'
      );
        ...
        <div className="page-content">
          <Container fluid={true}>
            <Breadcrumbs
              ...
              breadcrumbItem="Gestión de impuestos"
              breadcrumbItemUrl="/taxmanagement"
            />
            <Row>
