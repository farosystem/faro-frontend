...
import {
  convertirDataMovimientosActivosExcel,
...
const AssetsMove = ({ ...props }) => {
  ...
  const {
    loading: load_movimientos_activos,
    error: error_movimientos_activos,
    data: data_movimientos_activos
  } = useQuery(OBTENER_MOVIMIENTOS_ACTIVOS, { pollInterval: 1000 });
