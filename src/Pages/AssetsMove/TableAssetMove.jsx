  ...
  return (
    <div className="table-responsive mb-3">
          ...
          {data.map((move, i) => (
            <tr key={`assetMove-${i}`}>
              ...
              {mode === 'all' && (
                <>
                  <td>
                    {move.activos[0].nombre +
                      (move.activos.length > 1
                        ? ', ... ' + (move.activos.length - 1) + ' más'
                        : '')}
                  </td>
                  <td>
                    {move.activos[0].referenciaInterna +
                      (move.activos.length > 1
                        ? ', ... ' + (move.activos.length - 1) + ' más'
                        : '')}
                  </td>
      ...
      <Modal isOpen={modal} toggle={toggle} size="lg">
        <ModalHeader toggle={toggle}>{selectedMove.consecutivo}</ModalHeader>
        <ModalBody>
          <Row>
            ...
            <div className="col-md-4 col-sm-12 mb-3">
              ...
              <input
                ...
                type="text"
                id="beneficiario"
                value={selectedMove.beneficiario}
              />
            </div>
            <div className="col-md-4 col-sm-12 mb-3">
              ...
              <input
                ...
                type="text"
                id="fecha"
                value={selectedMove.fecha ? getFechaTZ('fechaHora', selectedMove.fecha) : ''}
              />
            </div>
          </Row>
          <div className="table-responsive mb-3">
