        ...
        <tbody>
          {data.map((proveedor, i) => (
            <tr key={`Supplier-${i}`}>
              ...
              <td>
                {proveedor.provedurias && proveedor.provedurias.length > 0
                  ? proveedor.provedurias[0].tipo + '...'
                  : ''}
              </td>
              <td>
                {proveedor.correos && proveedor.correos.length > 0
                  ? proveedor.correos[0].email
                  : ''}
              </td>
              <td>
                {proveedor.telefonos && proveedor.telefonos.length > 0
                  ? proveedor.telefonos[0].telefono +
                    (proveedor.telefonos[0].ext ? ', ext: ' + proveedor.telefonos[0].ext : '')
                  : ''}
              </td>
              <td>
                <div className="d-flex">
                  ...
                  <ButtonIconTable
                    ...
                    color="danger"
                    onClick={() => {
                      onClickDelete(proveedor.id, proveedor.empresa);
                    }}
                  />
                </div>
              </td>
