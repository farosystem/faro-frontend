...
export const OBTENER_TODAS_MATERIAS_PRIMAS = gql`
  query obtenerTodasMateriasPrimas {
...
export const OBTENER_MATERIAS_PRIMAS_REPORTE = gql`
  query obtenerMateriasPrimasReporte($unidad: String, $minimo: Number, $maximo: Number) {
    obtenerMateriasPrimasReporte(unidad: $unidad, minimo: $minimo, maximo: $maximo) {
      nombre
      pais
      unidad
      existencias
...
export const OBTENER_MATERIAS_PRIMAS_DE_ORDENES = gql`
  query ObtenerMateriasPrimasDeOrdenes(
    $proveedorId: ID
    $fechaInicio: Date
    $fechaFin: Date
    $unidad: String
    ...
    obtenerMateriasPrimasDeOrdenes(
